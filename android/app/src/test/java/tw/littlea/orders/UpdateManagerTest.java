...
public class UpdateManagerTest {
 ...
 @Test public void failedCheckRetriesSoonInsteadOfWaitingSixHours(){assertEquals(60000L,UpdateManager.retryDelay(false));assertEquals(21600000L,UpdateManager.retryDelay(true));}
}
